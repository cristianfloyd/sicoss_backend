...
class TopesProcessorTester:
    ...
    def test_legajo(self, nro_legaj: int, per_anoct: int, per_mesct: int) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'topes_aplicados': self._analizar_topes_aplicados(df_procesado.iloc[0], df_con_topes.iloc[0])
            }
    ...
    def _preparar_datos_para_topes(self, df: pd.DataFrame):
        ...
        df['ImporteImponiblePatronal'] = df.get('ImporteSAC', 0) + df.get('ImporteAdicionales', 0)
    ...
    def _analizar_topes_aplicados(self, antes: pd.Series, despues: pd.Series) -> Dict[str, Any]:
        ...
        if despues.get('DiferenciaImponibleConTope', 0) > 0:
            ...
            analisis['diferencia_imponible'] = despues.get('DiferenciaImponibleConTope', 0)
